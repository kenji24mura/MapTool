...
namespace MapComLib
{
    public class Convert
    {
        ...
        //世界測地系→日本測地系
        public static void ConvW2J(long Mx, long My, ref long pCx, ref long pCy)
        {
        ...
        //日本測地系→世界測地系
        public static void ConvJ2W(long Mx, long My, ref long pCx, ref long pCy)
        {
            // TODO: この位置にコントロール通知ハンドラ用のコードを追加してください
        ...
        // 経緯度から正規化座標系へ
        //
        public static int gpconv(double m_keido, double m_ido, int kijyunkei, ref double lx, ref double ly)
        {
        ...
        public static int gpconv2(double lx, double ly, int kijyunkei, ref double m_keido, ref double m_ido)
        {
